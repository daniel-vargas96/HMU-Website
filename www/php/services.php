		...
		<div class="row">
			<ul class="services-list clearfix padding-top-70">
				...
				<li>
					...
					<h4 class="box-header"><a href="?page=service_air_conditioning" title="Air Conditioning">AIR CONDITIONING<span class="template-arrow-menu"></span></a></h4>
				</li>
				<li>
					<a href="?page=service_brake_repair" title="Brake Repair">
						<img src="images/samples/390x260/image_05.jpg" alt="">
					</a>
					<h4 class="box-header"><a href="?page=service_brake_repair" title="Brake Repair">BRAKE REPAIR<span class="template-arrow-menu"></span></a></h4>
				</li>
				<li>
					<a href="?page=service_tire_wheel" title="Tire and Wheel Services">
						<img src="images/samples/390x260/image_06.jpg" alt="">
					</a>
					<h4 class="box-header"><a href="?page=service_tire_wheel" title="Tire and Wheel Services">TIRE AND WHEEL SERVICES<span class="template-arrow-menu"></span></a></h4>
				</li>
			</ul>
		</div>
	</div>
