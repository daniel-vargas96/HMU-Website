<nav>
	<ul class="sf-menu">
		<li<?php echo ($_GET["page"]=="" || $_GET["page"]=="home" || $_GET["page"]=="home2" ? " class='selected'" : ""); ?>>
			...
			<ul>
				...
				<li<?php echo ($_GET["page"]=="home2" ? " class='selected'" : ""); ?>>
		...
		<li class="<?php echo ($_GET["page"]=="team" ? " selected" : ""); ?>">
		...
		<li<?php echo ($_GET["page"]=="about" || $_GET["page"]=="404" ? " class='selected'" : ""); ?>>
			...
			<ul>
				...
				<li<?php echo ($_GET["page"]=="services2" ? " class='selected'" : ""); ?>>
				...
				<li<?php echo ($_GET["page"]=="team" ? " class='selected'" : ""); ?>>
					<a href="?page=team" title="Team">
						Team
					</a>
				</li>
				<li<?php echo ($_GET["page"]=="team_mark_whilberg" ? " class='selected'" : ""); ?>>
		...
		<li<?php echo ($_GET["page"]=="blog" || $_GET["page"]=="blog_left_sidebar" || $_GET["page"]=="blog_2_columns" || $_GET["page"]=="blog_3_columns" || $_GET["page"]=="post" || $_GET["page"]=="search" ? " class='selected'" : ""); ?>>
			...
			<ul>
				...
				<li<?php echo ($_GET["page"]=="blog_3_columns" ? " class='selected'" : ""); ?>>
